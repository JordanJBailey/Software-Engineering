        ...
        
{
    ...
    //--Binds w,a,s,d to move the player--
    public void keyBinding(JPanel panel){
        InputMap im = panel.getInputMap(JPanel.WHEN_IN_FOCUSED_WINDOW);
        ActionMap am = panel.getActionMap();
        
        //Finds out what key is pressed and looks at the the mapkey
        im.put(KeyStroke.getKeyStroke(KeyEvent.VK_W, 0), "North");
        im.put(KeyStroke.getKeyStroke(KeyEvent.VK_A, 0), "West");
        im.put(KeyStroke.getKeyStroke(KeyEvent.VK_S, 0), "South");
        im.put(KeyStroke.getKeyStroke(KeyEvent.VK_D, 0), "East");

        //An action is taken by calling an inner class if the mapkey matches
        am.put("North", new Move(MoveDirection.NORTH));
        am.put("West", new Move(MoveDirection.WEST));
        am.put("South", new Move(MoveDirection.SOUTH));
        am.put("East", new Move(MoveDirection.EAST));
    }
    
    //Inner class for keyBinding method
    public class Move extends AbstractAction{
        private MoveDirection md;

        public Move(MoveDirection md){
            this.md = md;
        }
        @Override
        public void actionPerformed(ActionEvent e) {
            //Player moves
            if(game.isPlayerMovePossible(md)){
                game.playerMove(md);
            }
        }
    }
    //--End of binding keyboard input -- 
    ...
    private void initComponents() {
        ...
        map.setBorder(javax.swing.BorderFactory.createEmptyBorder(10, 10, 10, 10));
        map.setLayout(new java.awt.BorderLayout(10, 0));
        ...
        map.add(Grid, java.awt.BorderLayout.CENTER);
        ...
        backpack.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        backpack.setName(""); // NOI18N
        backpack.setRequestFocusEnabled(false);
        backpack.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                backpackActionPerformed(evt);
            }
        });
        pnlPlayer.add(backpack, java.awt.BorderLayout.PAGE_END);
        ...
        pnlPlayer.add(jButton2, java.awt.BorderLayout.PAGE_START);
        ...
        map.add(pnlControls, java.awt.BorderLayout.EAST);
    ...
    private void backpackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backpackActionPerformed
        ...
        final Inventory I = new Inventory(game);
    ...
    private void initIslandGrid()
    {
        ...
        for ( int row = 0 ; row < rows ; row++ )
        {
            ...
            {
                Grid.add(new GridSquarePanel(game, row, col));
            }
        }
    }
